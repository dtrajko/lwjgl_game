...
public class Fbo {
	...
	private void initialiseFrameBuffer(int type) {
		...
		if (this.multisampleAndMultiTarget) {
			this.colourBuffer = createMultisampleColourAttachment(GL30.GL_COLOR_ATTACHMENT0);
			this.colourBuffer2 = createMultisampleColourAttachment(GL30.GL_COLOR_ATTACHMENT1);
		} else {
