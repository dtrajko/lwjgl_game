...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		FlareManager lensFlare = new FlareManager(0.4f,
			new FlareTexture(texture6, 0.5f),
			new FlareTexture(texture4, 0.23f),
			new FlareTexture(texture2, 0.1f),
			new FlareTexture(texture7, 0.05f),
			new FlareTexture(texture3, 0.06f),
			new FlareTexture(texture5, 0.07f),
			new FlareTexture(texture7, 0.2f),
			new FlareTexture(texture3, 0.07f),
			new FlareTexture(texture5, 0.3f),
			new FlareTexture(texture4, 0.4f),
