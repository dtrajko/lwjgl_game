...
public class HeightMapTerrain implements ITerrain {
	...
	public HeightMapTerrain(float gridX, float gridZ, RawModelLoader loader, TerrainTexturePack texturePack, 
	...
	public void render(ITerrainRenderer renderer, ICamera camera, Light light, Vector4f clipPlane) {
		System.out.println("Render the terrain " + this.getClass() + " using the '" + renderer.getClass() + "' renderer.");
	...
	private RawModel generateTerrain(RawModelLoader loader, String heightMap){
